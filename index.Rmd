...
author: "Samuel Goëta, Joël Gombin, Mathieu Morey"
date: "octobre 2019"
output:
...
Ces slides en ligne : `r paste0("http://moreymat.github.io/", params$slug)`

Sources : `r paste0("https://github.com/moreymat/", params$slug)`
...
**23/10** : culture des données. Data, big data, open data. Pratique.

**31/10** : Pratique. Données sales. Données non structurées. Étude de cas (data pipeline).
